...
export default function ReactivosList() {
  ...
  // Agrupamos los movimientos por ID de reactivo
  const stockMap = {};

  (movimientos || []).forEach((movimiento) => {
    if (!stockMap[movimiento.reactivo_id]) {
      stockMap[movimiento.reactivo_id] = [];
    }
    stockMap[movimiento.reactivo_id].push(movimiento);
  });

  // Calculamos el stock dinámico por cada reactivo mapeado y filtramos la búsqueda
                              ...
                              <AlertDialog>
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      Se desactivará "{r.nombre}" del inventario.
                                      Los movimientos del kardex se conservarán.
                                    </AlertDialogDescription>
                                  </AlertDialogHeader>
